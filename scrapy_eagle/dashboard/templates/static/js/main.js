...
},{"../services/httpservice":175,"./ListItem.jsx":170,"react":167}],170:[function(require,module,exports){
var React = require('react');
    ...
    render: function () {
        return React.createElement(
            ...
            React.createElement(
                'h4',
                null,
                this.props.memory_used_mb,
                ' - ',
                this.props.memory_available_mb
            )
        );
    }
...
var ServerNode = React.createClass({
  ...
  render: function () {
    ...
    var listSubProcesses = this.state.subprocesses.map(function (item) {
      return React.createElement(ServerSubProcess, {
        key: item.pid,
        pid: item.pid,
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          null,
          'Memory Used Server : ',
          this.state.memory_used_server_mb,
          'mb'
        ),
        React.createElement(
          'li',
        ...
        React.createElement(
          ...
          null,
          'Memory Available: ',
          this.state.memory_available_mb,
          'mb'
        ),
        React.createElement(
          'li',
        ...
        React.createElement(
          ...
          React.createElement(
            'button',
            { onClick: this.onClickExecCommand },
            'Exec Sample Command'
          )
        ),
        React.createElement(
          ...
          React.createElement(
            'select',
            { onChange: this.onChangeDataProvider },
            React.createElement(
              'option',
              { value: '' },
              '--- choose a spider'
          ...
          React.createElement(
            'button',
            { onClick: this.onClickStartWorker },
            'Start Worker'
          )
        ),
        React.createElement(
...
},{"./ServerSubProcess.jsx":173,"react":167}],172:[function(require,module,exports){
var React = require('react');
...
var ServerSet = React.createClass({
  ...
  render: function () {
    var listServers = this.state.server_set.map(function (item) {
      return React.createElement(ServerNode, {
        key: item.public_ip,
...
},{"./ServerNode.jsx":171,"react":167}],173:[function(require,module,exports){
var React = require('react');

var ServerSubProcess = React.createClass({
  displayName: "ServerSubProcess",
  ...
  onClickKill: function () {
    ...
    $.get("http://" + this.props.public_ip + ":5000/kill_subprocess/" + this.props.pid, function (data) {});
  },
  componentDidMount: function () {
    this.setState({ 'link_open_buffer': "http://" + this.props.public_ip + ":5000/read_buffer/" + this.props.pid });
  },
  render: function () {
    return React.createElement(
      "li",
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            "a",
            { href: this.state.link_open_buffer, target: "_blank" },
            React.createElement(
              "button",
              null,
              "Open Buffer"
...
ReactDOM.render(React.createElement(ServerSet, null), document.getElementById('server_set'));

},{"./components/List.jsx":169,"./components/ServerNode.jsx":171,"./components/ServerSet.jsx":172,"react":167,"react-dom":29}],175:[function(require,module,exports){
